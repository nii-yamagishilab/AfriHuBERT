...
for model in xlsr_lg_300m xlsr_lg_53; do
	# mhubert_147 ssa_hubert_60k hubert_lg_ll60k xlsr_lg_53 xlsr_lg_300m; do
    echo $model
    mkdir -p $CODEDIR/scripts_infer/output/$setts  $CODEDIR/scripts_infer/tmp/xlsr_lg_300m/
