...
def main(args):
   ...
   models = {
       'mhubert_147':{'model_hub': 'utter-project/mHuBERT-147', 'save': 'hubert', 'hidden_size': 768, 'lin_neurons':512, 'model_dir': 'CKPT+2024-07-17+16-08-45+00' },
       'ssa_hubert_60k':{'model_hub': 'Orange/SSA-HuBERT-base-60k', 'save': 'hubert', 'hidden_size': 768, 'lin_neurons':512, 'model_dir': 'CKPT+2024-07-17+17-54-01+00' }, 
       'hubert_lg_ll60k':{'model_hub': 'facebook/hubert-large-ll60k', 'save': 'hubert', 'hidden_size': 1024, 'lin_neurons':512, 'model_dir': 'CKPT+2024-07-17+19-24-25+00'}, 
       'xlsr_lg_53':{'model_hub': 'facebook/wav2vec2-large-xlsr-53', 'save': 'wav2vec', 'hidden_size': 1024, 'lin_neurons':512, 'model_dir': 'CKPT+2024-07-17+22-28-29+00'}, 
       'xlsr_lg_300m':{'model_hub': 'facebook/wav2vec2-xls-r-300m', 'save': 'wav2vec', 'hidden_size': 1024, 'lin_neurons':512, 'model_dir':  'CKPT+2024-07-17+22-35-15+00'},
       ...
       'af_xlsr_lg_300m': {'model_hub': 'facebook/wav2vec2-xls-r-300m', 'save': 'wav2vec', 'hidden_size': 1024, 'lin_neurons':512, 'model_dir':  'CKPT+2024-07-19+04-38-08+00'}
   ...
   data['pretrained_path'] = f"{outurl}/{resultname}/{modelname}/{data['seed']}/save/{models[modelname]['model_dir']}"
   data['label_path'] = f"{outurl}/{resultname}/{modelname}/{data['seed']}/save"
   data['wav2vec2_folder'] = ruamel.yaml.comments.TaggedScalar(tag="!ref", value=f"<label_path>/{models[modelname]['save']}")
...
if __name__ == "__main__":
   ...
   parser.add_argument('--oldyaml', type=str, default="../hparams_infer/hyperparams.yaml", help='The old yaml file to update or start with')
