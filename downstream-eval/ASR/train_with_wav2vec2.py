...
if __name__ == "__main__":
    ...
    '''
    shutil.copy(hparams["model_dir"], hparams["save_folder"])
    shutil.copy(hparams["model_dir"].replace("model","vocab"), hparams["save_folder"])
    ...
    #tokenizer.load(hparams["model_dir"])
