...
# voxlingua
# Uses 16kHz
for lan in af_za  am_et  ar_eg  en_us  ff_sn  fr_fr  ha_ng  ig_ng  kam_ke  lg_ug  ln_cd  luo_ke  nso_za; do
        #	ny_mw  om_et  pt_br  rw_rw  sn_zw  so_so  sw_ke  umb_ao  wo_sn  xh_za  yo_ng  zu_za; do
	echo $lan
